...
app.post('/api/simplify', async (req, res) => {
  try {
    ...
    // ✅ PRODUCTION-GRADE PROMPT SYSTEM v3
...
- Avoid literal translation sentence structure
...
- Use "စွမ်းအင်စနစ်" for energy infrastructure
- Use "တစ်ပြိုင်နက်တည်း" for simultaneous — place naturally in sentence flow
- Write shorter clauses — avoid stacking too many nouns together
- Use accessible educational Burmese tone, not overly formal written Burmese`
      : targetLang === 'Thai'
...
- Avoid overly formal phrases like "การบรรเทาผลกระทบ" or "อย่างมีนัยสำคัญ"
...
- Restore simultaneous relationships: "while also", "at the same time"
...
- simultaneous and causal structure preserved
- natural fluency in ${targetLang} for native speakers
- clarity without losing nuance

TARGET: near state-of-the-art educational simplification quality.
