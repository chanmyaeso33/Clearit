...
app.post('/api/simplify', async (req, res) => {
  try {
    ...
    const langInstruction = targetLang === 'Burmese'
      ? 'You MUST write ONLY in Burmese script (Myanmar Unicode \u1000-\u109F). No English words allowed in the output.'
      : targetLang === 'Thai'
      ? 'You MUST write ONLY in Thai script. No English words allowed in the output.'
...
- Keep logical relationships between ideas
...
Respond ONLY with a valid JSON object. No markdown. No explanation. No backticks.`
      ...
      {
        role: 'user',
        content: `Step 1: Identify the core meaning, logical relationships, cause-and-effect structure, and important nuances in this text.
Step 2: Rewrite it in clear, natural, easy-to-understand ${targetLang} while preserving everything from Step 1.
...
- Do NOT oversimplify or remove key information
- Do NOT use vague wording — stay precise
- Preserve causal relationships (because, therefore, while, simultaneously)
...
Optimize for ALL categories equally. Do not sacrifice meaning for brevity.
