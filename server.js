...
Fix OCR mistakes carefully. Preserve original meaning and language exactly.
Do NOT translate. Do NOT summarize. Do NOT hallucinate missing information.
Output ONLY the cleaned text in its original language (${imageScript}). No explanation.`
        },
        {
          role: 'user',
          content: `Fix OCR errors in this ${imageScript} text. Keep all original content.
Replace [?] markers with your best guess based on context, or remove if truly unreadable.
Do NOT change the language or meaning.
